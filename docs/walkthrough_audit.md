...
| P1 | Resolução ainda não promovida | A implementação F4.6 está concluída somente na branch local e depende de publicação, PR e CI remota | F4.6; promoção pendente |
