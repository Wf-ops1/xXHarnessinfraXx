...
reconciliação `docs/promote-f6.4` está `LOCAL_READY / PUBLICATION_PENDING`, sem upstream; F6.5 não
...
| F6 | F6.4 | [Doctor real](completed/F6.4.md) | PR #75 / head final `6e6ebb8` / CI `31928606331`; merge `574df7a` / pós-merge `31929031317`; administrativo local pendente |
