...
`8be6789` e recebeu CI pós-merge verde no run `31963338576`. A reconciliação administrativa está
`LOCAL_READY / PUBLICATION_PENDING` em `docs/promote-f6.6`. Knowledge permanece `known_gap_f6_7`;
a F6.7 não foi iniciada.
...
| F6 | F6.6 | [Recovery e testes de falha](completed/F6.6.md) | PR #79 / head `1ce953d` / CI `31962221925`; merge `8be6789` / pós-merge `31963338576`; administrativo local `docs/promote-f6.6` pendente de publicação |
