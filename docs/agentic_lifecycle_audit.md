...
| Memória | `CodebaseMemoryAdapter` + `SnapshotManager` | Snapshot canônico por SHA Git real, com schema, status e digest validados | Contrato de armazenamento implementado | Não gera AST; snapshot precisa existir e o indexador local real fica para F4.2 |
