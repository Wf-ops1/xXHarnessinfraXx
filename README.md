...
- **Fase 4 iniciada:** F3.1–F3.6, F3.8 e as corretivas F3.C1/F3.C2 aplicáveis foram
  ...
  A reconciliação administrativa F4.3 está certificada na branch `docs/promote-f4.3` e foi aberta no
  PR #37; seus checks ainda estão pendentes e o merge não foi autorizado. Nenhuma tag foi publicada.
