...
- **Fase 4 iniciada:** F3.1–F3.6, F3.8 e as corretivas F3.C1/F3.C2 aplicáveis foram
  ...
  exclusivo, ficou verde localmente em regressão/quality/package e aguarda publicação/PR; o estado
  operacional e a F4.5 permanecem bloqueados. Nenhuma tag foi publicada, e F3.7 continua dependente
  da F4.7.
