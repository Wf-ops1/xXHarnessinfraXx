...
- **Fase 4 iniciada:** F3.1–F3.6, F3.8 e as corretivas F3.C1/F3.C2 aplicáveis foram
  ...
  administrativa está local em `docs/promote-f4.6` e ainda precisa ser incorporada; F3.7 continua
  dependente da F4.7.
...
- [ContextAssembler](src/ai_engineering_harness/runtime/context_assembler.py) calcula as seis dimensões
  ...
  worktree e preserva no terminal o launcher ativo selecionado por `sys.prefix`; a reconciliação
  administrativa ainda bloqueia o próximo gate, enquanto persistência e guard permanecem na F4.7;
