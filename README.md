...
- **Fase 4 iniciada:** F3.1–F3.6, F3.8 e as corretivas F3.C1/F3.C2 aplicáveis foram
  ...
  overwrite entre snapshots concorrentes divergentes do mesmo SHA. A corretiva F4.C1 usa claim
  exclusivo, ficou verde localmente em regressão/quality/package e está no PR #40; a CI do head final
  ainda precisa concluir. O estado operacional e a F4.5 permanecem bloqueados. Nenhuma tag foi
  publicada, e F3.7 continua dependente da F4.7.
