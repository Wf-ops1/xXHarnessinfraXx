...
- **Fase 4 iniciada:** F3.1–F3.6, F3.8 e as corretivas F3.C1/F3.C2 aplicáveis foram
  ...
  também concluiu 11/11. Sua reconciliação administrativa está certificada somente na branch local
  `docs/promote-f4.4`, aguardando autorização própria para publicação e PR. Nenhuma tag foi publicada,
  e F3.7 continua dependente da F4.7.
