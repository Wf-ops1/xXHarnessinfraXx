...
- **Fase 4 iniciada:** F3.1–F3.6, F3.8 e as corretivas F3.C1/F3.C2 aplicáveis foram
  ...
  administrativa está local em `docs/promote-f4.c1`, sem publicação, e a F4.5 permanece bloqueada até
  seu merge e CI pós-merge verde. Nenhuma tag foi publicada, e F3.7 continua dependente da F4.7.
