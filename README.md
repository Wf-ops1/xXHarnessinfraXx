...
- **Fase 4 iniciada:** F3.1–F3.6, F3.8 e as corretivas F3.C1/F3.C2 aplicáveis foram
  ...
  recertificação local integral e aguarda atualização do PR e nova CI. F3.7 continua dependente da F4.7.
...
- [ContextAssembler](src/ai_engineering_harness/runtime/context_assembler.py) calcula as seis dimensões
  ...
  e o R2 local do PR #44 preserva o launcher POSIX; atualização/CI remota ainda bloqueiam promoção,
  enquanto persistência e guard permanecem na F4.7;
